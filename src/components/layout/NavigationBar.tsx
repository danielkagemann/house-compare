...
export const NavigationBar = () => {
   ...
   // w-20 is 80px
   return (
      <nav className="bg-gray-600 text-white w-full md:w-20 h-full flex md:flex-col md:items-center space-x-4 md:space-x-0 md:justify-start justify-center md:space-y-8 py-4 md:py-16">
         <Link href="/?init">
